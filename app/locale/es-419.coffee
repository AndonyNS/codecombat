module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  ...
  nav:
    ...
    help_pref: "¿Necesitas ayuda? ¡Envianos un correo electrónico!"
...
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    hey_students: "Estudiante, ingresa el código de clase de tu maestro."
    birthday: "Cumpleaños"
    parent_email_blurb: "Sabemos que no puedes esperar para aprender a programar - ¡También estamos emocionados! Tus padres recibirán un email con más información acerca de como crear una cuenta para tí. Email {{email_link}} si tienes alguna pregunta."
    classroom_not_found: "No existen clases con este Código de Clase. Revise que el nombre es correcto o pida ayuda a su maestro."
